...
Page({
  ...
  syncKeyboardLayout(height = 0) {
    ...
    const shortcutPanelHeight = keyboardHeight > 0 ? SHORTCUT_PANEL_HEIGHT_RPX : 0
    const contentHeight = `calc(100vh - ${navHeight}px - ${safeAreaBottom}px - ${keyboardHeight}px - ${btnHeight}rpx - ${shortcutPanelHeight}rpx)`
    this.setData({
      keyboardHeight,
      contentHeight
    })
